<template>
	<div id="app">
		...
		<keep-alive>
			<router-view id="r-view" :style="{height:isShowTabbar?'calc(100vh - 50px)':'100vh'}" />
		</keep-alive>


		<van-tabbar v-model="activeIndex" :border="true" id="tabbar" v-show="isShowTabbar">
	...
	export default {
		...
		methods: {
			checkActiveIndex(to) {
				...
				let deep = to.path.split("/").length - 1;
				console.log(deep);
				this.isShowTabbar = deep <= 1;
				// if(deep>1){
